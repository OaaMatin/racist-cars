...
public class Customize extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        readycar1 = new Button("Ready Car1");
        readycar2 = new Button("Ready Car2");
        ...
        primaryStage.setTitle("Customize Screen");
    ...
    private void updateCar1ImageZoom(int newindex, int oldindex) {
        ...
        if (newindex >= 0 && newindex < car1Images.size()) {
            car1Images.get(newindex).setScaleX(1.2);
            car1Images.get(newindex).setScaleY(1.2);
        }
    }
    ...
    private void updateCar2ImageZoom(int newindex, int oldindex) {
        ...
        if (newindex >= 0 && newindex < car1Images.size()) {
            car2Images.get(newindex).setScaleX(1.2);
            car2Images.get(newindex).setScaleY(1.2);
        }
    }
    ...
    private void updateSelectionPosition(GridPane grid, Rectangle rect, int index, int columns, double cellWidth, double cellHeight) {
        ...
        rect.setTranslateX(col * (cellWidth + grid.getHgap()));
        rect.setTranslateY(row * (cellHeight + grid.getVgap()));
    }
    ...
    private void checkIfBothReady(Pane root) {
        if (iscar1ready && iscar2ready && startCancelBox == null) {
            ...
            startBtn.setStyle("-fx-background-color: #2980b9; -fx-text-fill: white; -fx-font-size: 20px; -fx-background-radius: 15;");
            cancelBtn.setStyle("-fx-background-color: #c0392b; -fx-text-fill: white; -fx-font-size: 20px; -fx-background-radius: 15;");
